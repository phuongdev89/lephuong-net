...
defined('APP_PATH') || define('APP_PATH', BASE_PATH . DIRECTORY_SEPARATOR . 'frontend');
 ...
 */
defined('PTOOLSPATH') || define('PTOOLSPATH', 'C:\Users\Le Phuong\AppData\Roaming\Composer\vendor\phalcon\devtools');
